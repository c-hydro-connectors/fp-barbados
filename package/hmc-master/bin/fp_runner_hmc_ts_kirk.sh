...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP RUNNER - HMC OBS WS Realtime'
...
setting_file='/share/c-hydro/hmc-master/config/algorithms/hmc_model_run-manager_algorithm_ts_kirk.config'

# Get information (-u to get gmt time)
#time_now=$(date -u +"%Y%m%d%H00")
time_now='201809290000' # DEBUG 
#-----------------------------------------------------------------------------------------
