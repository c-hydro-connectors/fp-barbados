...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP RUNNER - HMC NWP WRF Realtime'
script_version="1.0.0"
script_date='2018/10/10'
...
setting_file='/share/c-hydro/hmc-master/config/algorithms/hmc_model_run-manager_algorithm_nwp_wrf_realtime.config'

# Get information (-u to get gmt time)
#time_now=$(date -u +"%Y%m%d%H00")
#time_now=$(date --date="1 days ago" -u +"%Y%m%d%H00") 
time_now=$(date +"%Y%m%d%H00")
# time_now='202108040900' # DEBUG 
#-----------------------------------------------------------------------------------------
