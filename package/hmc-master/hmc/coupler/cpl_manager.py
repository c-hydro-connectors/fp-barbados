...
class cpl_manager:
    ...
    def __init__(self, DataSettings=FileSettings,
        ...
        self.oDataVarStatic_VAR = DataVarStatic
        self.oDataVarDynamic_VAR = DataVarDyn
        self.oDataTime_VAR = DataTime

        self.oDataNamelist_VAR = DataNamelist
        self.sFileNamelist_VAR = FileNamelist
        self.sFileNameExec_VAR = FileNameExec
        # -------------------------------------------------------------------------------------
    ...
    def Builder(self, sRunMode, oRunArgs):
        ...
        self.oDataTime = deepcopy(self.oDataTime_VAR)
        # -------------------------------------------------------------------------------------
        ...
        oDrv_Builder_Info = HMC_Builder_Info(DataSettings=deepcopy(self.oDataSettings_VAR),
                                             ...
                                             DataVarStatic=deepcopy(self.oDataVarStatic_VAR),
                                             DataVarDynamic=deepcopy(self.oDataVarDynamic_VAR),
        ...
        oDrv_Builder_Namelist = HMC_Builder_Namelist(DataSettings=self.oDataSettings,
                                                     ...
                                                     DataVarDynamic=self.oDataVarDynamic,
                                                     DataTime=self.oDataTime,
                                                     DataNamelist=deepcopy(self.oDataNamelist_VAR),
                                                     FileNamelist=deepcopy(self.sFileNamelist_VAR))
    ...
    def Runner(self, sRunMode, oRunArgs):
        ...
        oDrv_Runner_Info = HMC_Runner_Info(DataSettings=self.oDataSettings,
                                           ...
                                           FileNameExec=deepcopy(self.sFileNameExec_VAR)
                                           )
