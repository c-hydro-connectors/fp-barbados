...
from hmc.default.lib_default_datastatic import DataInput as DataStaticInput_Default
from hmc.default.lib_default_datastatic import DataInput as DataDynamicInput_Default
...
def updateData_NML(oDataSettings=FileSettings,
                   oDataTags=ConfigTags,
                   oDataStatic=DataStaticInput_Default,
                   oDataDynamic=DataDynamicInput_Default,
                   oDataTime=DataTime_Default,
                   oDataNamelist=DataNamelist_Default):
    ...
    oDataNamelist['HMC_Namelist']['sPathData_Static_Point'] = oDataStatic['DataInput']['Point']['FilePath']
    oDataNamelist['HMC_Namelist']['iFlagTypeData_Static'] = oDataStatic['DataInput']['Point']['FileType']
    oDataNamelist['HMC_Namelist']['sPathData_Static_Gridded'] = oDataStatic['DataInput']['Gridded']['FilePath']
    oDataNamelist['HMC_Namelist']['iFlagTypeData_Static'] = oDataStatic['DataInput']['Gridded']['FileType']
    ...
    oDataNamelist['HMC_Namelist']['sPathData_Output_Gridded'] = oDataDynamic['DataOutput']['Gridded']['FilePath']
    oDataNamelist['HMC_Namelist']['iFlagTypeData_Output_Gridded'] = oDataDynamic['DataOutput']['Gridded']['FileType']
    oDataNamelist['HMC_Namelist']['sPathData_Output_Point'] = oDataDynamic['DataOutput']['Point']['FilePath']
    oDataNamelist['HMC_Namelist']['iFlagTypeData_Output_Point'] = oDataDynamic['DataOutput']['Point']['FileType']
    oDataNamelist['HMC_Namelist']['sPathData_Output_TimeSeries'] = oDataDynamic['DataOutput']['TimeSeries']['FilePath']
    oDataNamelist['HMC_Namelist']['iFlagTypeData_Output_TimeSeries'] = oDataDynamic['DataOutput']['TimeSeries'][
        'FileType']
...
def defineFile_NML(sFileName=join(FileSettings['ParamsInfo']['Run_Path']['PathExec'],
                                  FileSettings['ParamsInfo']['Run_VarExec']['RunModelNamelist']), oDataTags=ConfigTags):
