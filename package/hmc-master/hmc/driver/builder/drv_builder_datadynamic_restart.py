...
class HMC_Builder_DataDynamic_Restart:
    ...
    def __init__(self, DataSettings=FileSettings, DataTags=ConfigTags,
        ...
        self.sTimeRestart = DataTime['DataTime']['TimeRestart']
        ...
        self.oDataDynamicGridded = DataVarDynamic['DataRestart']['Gridded']
        self.oDataDynamicPoint = DataVarDynamic['DataRestart']['Point']
        # -------------------------------------------------------------------------------------
