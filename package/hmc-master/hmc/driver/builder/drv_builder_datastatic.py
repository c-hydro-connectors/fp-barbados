...
from hmc.data_static.lib_datastatic_generic import getFileStaticPoint, getFileStaticGridded, getFileStaticPointSection
...
class HMC_Builder_DataStatic:
    ...
    # -------------------------------------------------------------------------------------
    # Method ClassInit
    def __init__(self, DataSettings=FileSettings, DataTags=ConfigTags, DataVarStatic=DataStatic_Default):
        ...
        self.oDataForcingGridded_Info = DataSettings['ParamsInfo']['HMC_Data']

        self.oDataStaticGridded_INIT = DataVarStatic['DataInput']['Gridded']
        self.oDataStaticPoint_INIT = DataVarStatic['DataInput']['Point']

        self.oDataStaticGridded_RUN = DataStatic_Default['DataAllocate']['Gridded']
        self.oDataStaticPoint_RUN = DataStatic_Default['DataAllocate']['Point']
        # -------------------------------------------------------------------------------------
    ...
    def __getFileStaticPoint(self):
        ...
        for sVarKey, oVarFeat in iter(oFileVars_IN.items()):
            ...
            oStaticTags = updateRunTags({'VarName': sVarName}, StaticTags)
