...
Name:          lib_datadynamic_restart_binary
...
from os.path import join, isfile, exists, split
...
from hmc.utils.lib_utils_op_system import createFolder, copyFile, deleteFileName
...
# -------------------------------------------------------------------------------------
# Method to get restart gridded data (in binary format)
def getRestartGridded_Binary(sDataTime,
                             sRunMode='Deterministic', sDataFlag='ARCHIVE', sRefTime=None, iWaitTime=10,
                             oDataTags=ConfigTags,
                             oDataGridded=DataDynamic_Default['DataRestart']['Gridded'],
                             sPathTemp='/temp'):
    ...
    oDataCheck_OUT = {}
    for sVarKey, oVarData in oFileDyn['VarName'].iteritems():
