...
def getForcingTimeSeries_ASCII(sDataTime, sRunMode='Deterministic', sDataFlag='OBS', sRefTime=None, iWaitTime=10,
                               ...
                               oDataTimeSeries_IN=DataDynamic_Default['DataForcing']['TimeSeries'],
                               oDataTimeSeries_OUT=DataDynamic_Default['DataAllocate']['TimeSeries'],
...
def saveForcingTimeSeries_ASCII(sDataTime, sFileName,
                           ...
                           oDataTags=ConfigTags,
                           oDataPoint=DataDynamic_Default['DataAllocate']['Point']):
...
def getForcingPoint_ASCII(sDataTime, sRunMode='Deterministic', sDataFlag='OBS', sRefTime=None, iWaitTime=10,
                          oDataTags=ConfigTags,
                          oDataStatic=DataStatic_Default['DataAllocate']['Gridded'],
                          oDataPoint_IN=DataDynamic_Default['DataForcing']['Point'],
                          oDataPoint_OUT=DataDynamic_Default['DataAllocate']['Point'],
                          sPathTemp='/temp'):
