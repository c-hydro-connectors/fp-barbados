...
# -------------------------------------------------------------------------------------
# Resume dictionary
DataDynamic = dict(DataForcing=DataForcing, DataUpdating=DataUpdating,
                   DataOutput=DataOutput,
                   DataRestart=DataRestart, DataState=DataState,
                   DataObserved=DataObserved,
                   DataAllocate=DataAllocate, DataAnalysis=DataAnalysis)
# -------------------------------------------------------------------------------------
