...
python3 FP_DynamicData_GroundNetwork_WS.py -settingfile configuration_product.json -time YYYYMMDDHHMM

Version:
20180914 (2.5.0) --> Beta release for FloodProofs library
...
from fp.driver.dataset.ground_network.ws.drv_data_io_ws import DataProductCleaner, DataProductTime, \
    DataProductBuilder, DataProductAnalyzer, DataProductFinalizer
from fp.driver.dataset.ground_network.ws.drv_data_ancillary_ws import DataAncillaryBuilder
# -------------------------------------------------------------------------------------
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'fp_configuration_groundnetwork_ws.json'
