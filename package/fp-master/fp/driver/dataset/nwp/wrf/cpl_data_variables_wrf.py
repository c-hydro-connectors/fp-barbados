...
import fp.dataset.nwp.wrf.lib_wrf_variables as oVarMethods

from fp.utils.lib_utils_op_list import convertList2Str, mergeList
...
class DataVariables:
    ...
    def __computeVarTimes(self, iVarIndex_Start, iVarIndex_End):
    ...
    def computeVarData(self, **kwargs):
        ...
        if self.oVarFx:
            ...
            oVarTimes = self.__computeVarTimes(iVarIndex_Start, iVarIndex_End)
