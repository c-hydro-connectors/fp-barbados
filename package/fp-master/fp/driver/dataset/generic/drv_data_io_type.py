...
from fp.utils.lib_utils_op_system import defineFileExt
...
class FileBinary:
    ...
    def setFileLibIO(self):
        ...
        import fp.io.lib_data_io_binary as file_library
...
class FileGrib:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import fp.io.lib_data_io_grib as file_library
        self.oFileLibrary = file_library
...
class FileAscii:
    ...
    def setFileLibIO(self):
        ...
        import fp.io.lib_data_io_ascii as file_library
        self.oFileLibrary = file_library
...
class FileNetCDF:
    ...
    def setFileLibIO(self):
        ...
        import fp.io.lib_data_io_netcdf as file_library
        self.oFileLibrary = file_library
...
class FileHDF5:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import fp.io.lib_data_io_hdf5 as file_library
        self.oFileLibrary = file_library
...
class FileHDF4:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import fp.io.lib_data_io_hdf4 as file_library
        self.oFileLibrary = file_library
...
class FileCSV:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import fp.io.lib_data_io_csv as file_library
        self.oFileLibrary = file_library
