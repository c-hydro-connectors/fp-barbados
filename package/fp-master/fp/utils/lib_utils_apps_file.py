...
from fp.utils.lib_utils_apps_zip import getExtZip, addExtZip, removeExtZip, deleteFileUnzip

from fp.default.lib_default_args import sLoggerName
from fp.default.lib_default_args import sZipExt as sZipExt_Default

from fp.utils.lib_utils_op_system import createFolder, deleteFolder, copyFile, deleteFileName, createTemp

from fp.driver.dataset.generic.drv_data_io_type import Drv_Data_IO
from fp.driver.dataset.generic.drv_data_io_zip import Drv_Data_Zip
...
def handleFileData(sFileName, sPathTemp=None, bFileTemp=True):
