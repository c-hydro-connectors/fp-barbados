...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP RUNNER - DATA SPLITTING WRF Barbados'
...
setting_file='/share/c-hydro/fp-master/apps/tools/fp_configuration_datasplitting_barbados_history.json'

# Get information (-u to get gmt time)
#time_now=$(date -u +"%Y%m%d%H00")
time_now='201910220000' # DEBUG 
#-----------------------------------------------------------------------------------------
