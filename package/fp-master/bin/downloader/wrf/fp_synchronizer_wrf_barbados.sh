...
# ----------------------------------------------------------------------------------------
# Script information
script_name='FP DOWNLOADER - WRF BARBADOS'
script_version="1.0.0"
script_date='2018/10/08'
...
for day in $(seq 0 $days); do
	...
	echo " =====> Sync command execution --> rsync -av srvBB02:$data_folder_get $data_folder_put"
    if rsync -av srvBB02:$data_folder_get $data_folder_put; then
